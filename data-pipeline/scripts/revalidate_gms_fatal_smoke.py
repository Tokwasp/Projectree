...
from data_pipeline.evaluation.gms_fatal_smoke import run_git_snapshot
...
def main() -> int:
    ...
    report = (
        ...
        f"3. 실제 Provider 호출 수: {usage['http_request_count']} (Candidate 2 / B-model 4 / Embedding 9)\n"
