...
예:
  ...
  python scripts/run_m2_regression.py --meetings M2X --env-file /home/ssafy/poc-node-extraction/.env
...
from evaluation.regression import run_regression  # noqa: E402
